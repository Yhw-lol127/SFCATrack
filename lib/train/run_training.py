...
def main():
    ...
    parser.add_argument('--script', type=str, default='sfcatrack', help='Name of the train script.')
    parser.add_argument('--config', type=str, default='rgbt',help="Name of the config file.")
