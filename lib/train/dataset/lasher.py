...
class LasHeR(BaseVideoDataset):
    ...
    def _get_sequence_list(self, split):
        ...
        file_path = os.path.join(ltr_path, 'data_specs', 'mydataset_training_list.txt')#'lasher_{}.txt'.format(split))
    ...
    def _get_frame_path(self, seq_path, frame_id):
        ...
        rgb_frame_path = sorted(os.listdir(seq_path+'/Align/visible/'))
        ir_frame_path = sorted(os.listdir(seq_path+'/Align/infrared/'))
        rgb_pre=seq_path+'/Align/visible/'
        ir_pre=seq_path+'/Align/infrared/'
